package com.coding.prod_ready_feature.prod_ready_feature.controllers;
...
@RestController
@RequestMapping(path = "/audit") // this request for admin not for user admin can see anything
